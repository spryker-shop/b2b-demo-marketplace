...
class CartReorderApiTester extends ApiEndToEndTester
{
    ...
    public function assertItemHasMerchantReference(string $sku, string $merchantReference): void
    {
        ...
        $this->assertArrayHasKey(RestItemsAttributesTransfer::MERCHANT_REFERENCE, $itemsResourceAttributes);
    ...
    public function assertItemHasProductOfferReference(string $sku, string $productOfferReference): void
    {
        ...
        $this->assertArrayHasKey(RestItemsAttributesTransfer::PRODUCT_OFFER_REFERENCE, $itemsResourceAttributes);
