...
class PaymentCaptureFailedMessageTest extends Unit
{
    ...
    protected const string FINAL_ITEM_STATE = 'payment failed';

    protected PaymentCommunicationTester $tester;

    public function testGivenAnOrderItemIsPaymentCapturePendingWhenThePaymentCaptureFailedMessageIsHandledThenTheItemBecomesPaymentFailed(): void
    {
        // Arrange
