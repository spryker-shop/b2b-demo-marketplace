...
class NavigationGuiPresentationTester extends Actor
{
    ...
    public function submitUpdateNodeToCategoryType(string $categoryUrl_en_US, string $categoryUrl_de_DE): void
    {
        ...
        $this->fillField('//div[@id="localized_attributes_container-de_DE"]//input[contains(@name, "[category_url]")]', $categoryUrl_de_DE);
        $this->fillField('//div[@id="localized_attributes_container-en_US"]//input[contains(@name, "[category_url]")]', $categoryUrl_en_US);
