...
// The project sources dir may be a glob (e.g. ./src/Pyz/*/src/Pyz/Yves), so it is expanded to a real
// directory; style-dictionary requires a trailing separator on buildPath, so one is always appended.
 ...
 * it to the critical webpack entry. No-op (contributes nothing) when the project provides no token
 * source or style-dictionary is not installed.
 */
export default {
    name: 'design-tokens',
