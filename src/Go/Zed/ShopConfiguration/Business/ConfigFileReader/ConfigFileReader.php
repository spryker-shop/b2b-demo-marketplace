...
class ConfigFileReader implements ConfigFileReaderInterface
{
    ...
    /**
     * @var \Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\YamlParser
     */
    protected YamlParser $yamlParser;

    /**
     * @var \Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\XmlParser
     */
    protected XmlParser $xmlParser;

    /**
     * @var \Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\JsonParser
     */
    protected JsonParser $jsonParser;

    /**
     * @param \Go\Zed\ShopConfiguration\ShopConfigurationConfig $config
     * @param \Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\YamlParser $yamlParser
     * @param \Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\XmlParser $xmlParser
     * @param \Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\JsonParser $jsonParser
     */
     ...
     *
     * @return \Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\ParserInterface|null
     */
    protected function getParserForExtension(string $extension): ?\Go\Zed\ShopConfiguration\Business\ConfigFileReader\Parser\ParserInterface
    {
