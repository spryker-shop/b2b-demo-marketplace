...
namespace Go\Zed\TenantAssigner\Communication\Controller;
 ...
 * @method \Go\Zed\TenantAssigner\Communication\TenantAssignerCommunicationFactory getFactory()
 */
class IndexController extends AbstractController
{
    ...
    public function tableAction(Request $request): array
    {
        ...
        $tenantTransfers = (new \Go\Zed\TenantOnboarding\Business\TenantOnboardingFacade())->getTenants(
