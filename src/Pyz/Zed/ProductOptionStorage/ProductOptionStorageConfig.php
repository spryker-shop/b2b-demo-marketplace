...
use Spryker\Shared\ProductOptionStorage\ProductOptionStorageConfig as SprykerSharedProductOptionStorageConfig;
...
class ProductOptionStorageConfig extends SprykerProductOptionStorageConfig
{
    ...
    {
        return SprykerSharedProductOptionStorageConfig::PUBLISH_PRODUCT_OPTION_QUEUE;
    }
}
