...
namespace Pyz\Zed\ShopConfiguration\Business\EffectiveConfigResolver;
...
use Pyz\Zed\ShopConfiguration\Persistence\ShopConfigurationRepositoryInterface;

class EffectiveConfigResolver implements EffectiveConfigResolverInterface
{
    /**
     * @var \Pyz\Zed\ShopConfiguration\Business\ConfigFileReader\ConfigFileReaderInterface
     */
    protected ConfigFileReaderInterface $configFileReader;

    /**
     * @var \Pyz\Zed\ShopConfiguration\Business\ConfigNormalizer\ConfigNormalizerInterface
     */
    protected ConfigNormalizerInterface $configNormalizer;

    /**
     * @var \Pyz\Zed\ShopConfiguration\Persistence\ShopConfigurationRepositoryInterface
     */
    ...
    /**
     * @param \Pyz\Zed\ShopConfiguration\Business\ConfigFileReader\ConfigFileReaderInterface $configFileReader
     * @param \Pyz\Zed\ShopConfiguration\Business\ConfigNormalizer\ConfigNormalizerInterface $configNormalizer
     * @param \Pyz\Zed\ShopConfiguration\Persistence\ShopConfigurationRepositoryInterface $repository
