...
use Go\Zed\ShopConfiguration\Communication\Console\ShopConfigurationPublishAllConsole;
use Go\Zed\ShopConfiguration\Communication\Console\ShopConfigurationPublishConsole;
use Go\Zed\ShopConfiguration\Communication\Console\ShopConfigurationRebuildConsole;
use Go\Zed\ShopConfiguration\Communication\Console\ShopConfigurationSetupConsole;
...
use Go\Zed\Oms\Communication\Console\CheckConditionConsole as OmsCheckConditionConsole;
use Go\Zed\Oms\Communication\Console\CheckTimeoutConsole as OmsCheckTimeoutConsole;
...
use Go\Zed\OrderMatrix\Communication\Console\OrderMatrixConsole;
...
use Go\Zed\PriceProductSchedule\Communication\Console\PriceProductScheduleApplyConsole;
use Spryker\Zed\PriceProductSchedule\Communication\Console\PriceProductScheduleCleanupConsole;
use Go\Zed\ProductDiscontinued\Communication\Console\DeactivateDiscontinuedProductsConsole;
use Go\Zed\ProductLabel\Communication\Console\ProductLabelRelationUpdaterConsole;
...
use Go\Zed\ProductValidity\Communication\Console\ProductValidityConsole;
...
use Go\Zed\SalesInvoice\Communication\Console\OrderInvoiceSendConsole;
...
class ConsoleDependencyProvider extends SprykerConsoleDependencyProvider
{
    ...
    public function getApplicationPlugins(Container $container): array
    {
        ...
        $applicationPlugins[] = new TenantProviderConsoleApplicationPlugin();
