...
class ProductRepository implements ProductRepositoryInterface
{
    ...
    public function getSkuProductAbstractList(): array
    {
        ...
        /**
         * @var array<string> $skuProductAbstractList
         */
        $skuProductAbstractList = $collection->toArray();

        return $skuProductAbstractList;
    }
    ...
    public function getSkuProductConcreteList(): array
    {
        ...
        /**
         * @var array<string> $skuProductConcreteList
         */
        $skuProductConcreteList = $collection->toArray();
