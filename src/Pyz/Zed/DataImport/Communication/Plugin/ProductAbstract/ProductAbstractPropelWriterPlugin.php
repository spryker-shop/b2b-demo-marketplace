 ...
 */
class ProductAbstractPropelWriterPlugin extends AbstractPlugin implements DataSetItemWriterPluginInterface
{
    public function write(DataSetItemTransfer $dataSetItemTransfer): void
    {
        $this->getFacade()->writeProductAbstractDataSet(new DataSet($dataSetItemTransfer->getPayload()));
    }
