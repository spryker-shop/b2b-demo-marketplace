 ...
 */
class ProductAbstractStorePropelWriterPlugin extends AbstractPlugin implements DataSetItemWriterPluginInterface
{
    public function write(DataSetItemTransfer $dataSetItemTransfer): void
    {
        $this->getFacade()->writeProductAbstractStoreDataSet(new DataSet($dataSetItemTransfer->getPayload()));
    }
