 ...
 */
class ProductConcretePropelWriterPlugin extends AbstractPlugin implements DataSetItemWriterPluginInterface
{
    public function write(DataSetItemTransfer $dataSetItemTransfer): void
    {
        $this->getFacade()->writeProductConcreteDataSet(new DataSet($dataSetItemTransfer->getPayload()));
    }
