 ...
 */
class ProductImagePropelWriterPlugin extends AbstractPlugin implements DataSetItemWriterPluginInterface
{
    public function write(DataSetItemTransfer $dataSetItemTransfer): void
    {
        $this->getFacade()->writeProductImageDataSet(new DataSet($dataSetItemTransfer->getPayload()));
    }
