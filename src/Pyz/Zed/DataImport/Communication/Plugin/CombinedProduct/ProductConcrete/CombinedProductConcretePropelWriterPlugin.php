 ...
 */
class CombinedProductConcretePropelWriterPlugin extends AbstractPlugin implements DataSetItemWriterPluginInterface
{
    public function write(DataSetItemTransfer $dataSetItemTransfer): void
    {
        $this->getFacade()->writeCombinedProductConcreteDataSet(new DataSet($dataSetItemTransfer->getPayload()));
    }
