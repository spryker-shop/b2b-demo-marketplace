 ...
 */
class CombinedProductAbstractPropelWriterPlugin extends AbstractPlugin implements DataSetItemWriterPluginInterface
{
    public function write(DataSetItemTransfer $dataSetItemTransfer): void
    {
        $this->getFacade()->writeCombinedProductAbstractDataSet(new DataSet($dataSetItemTransfer->getPayload()));
    }
