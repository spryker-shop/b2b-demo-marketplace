 ...
 */
class CombinedProductAbstractStorePropelWriterPlugin extends AbstractPlugin implements DataSetItemWriterPluginInterface
{
    public function write(DataSetItemTransfer $dataSetItemTransfer): void
    {
        $this->getFacade()->writeCombinedProductAbstractStoreDataSet(new DataSet($dataSetItemTransfer->getPayload()));
    }
