...
class DataImportDependencyProvider extends SprykerDataImportDependencyProvider
{
    ...
    protected function getDataImporterPlugins(): array
    {
        return [
            ...
            new MerchantProfileAddressDataImportPlugin(), new MerchantProductOfferDataImportPlugin(),
            ...
            new ProductOfferServiceDataImportPlugin(), new CombinedMerchantProductOfferDataImportPlugin(),
            ...
            new ProductConfigurationDataImportPlugin(), new MerchantCombinedProductOfferDataImportPlugin(),
