...
class OmsDependencyProvider extends SprykerOmsDependencyProvider
{
    ...
    {
        $container->extend(self::CONDITION_PLUGINS, function (ConditionCollectionInterface $conditionCollection) {// ----- Payment conditions
            ...
            $conditionCollection->add(new IsPaymentAppPaymentStatusRefundFailedConditionPlugin(), 'Payment/IsRefundFailed');return $conditionCollection;
        });
    ...
    protected function extendCommandPlugins(Container $container): Container
    {
        $container->extend(self::COMMAND_PLUGINS, function (CommandCollectionInterface $commandCollection) {
            ...
            $commandCollection->add(new RefundCommandPlugin(), 'Payment/Refund/Confirm');$commandCollection->add(new StripeCaptureCommandPlugin(), 'Stripe/Capture');
