...
namespace Pyz\Zed\TenantOnboarding\Communication\Plugin\Mail;
 ...
 */
class TenantOnboardingMailTypeBuilderPlugin extends AbstractPlugin implements MailTypeBuilderPluginInterface
{
    /**
     * @var string
     */
    public const MAIL_TYPE = 'tenant onboarding notification';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_HTML = 'tenantOnboarding/mail/tenant_onboarding_successful.html.twig';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_TEXT = 'tenantOnboarding/mail/tenant_onboarding_successful.text.twig';
    ...
    public function build(MailTransfer $mailTransfer): MailTransfer
    {
        ...
        return $mailTransfer
            ->setSubject('Your Registration in Spryker.Go is Successful')
            ->addTemplate(
