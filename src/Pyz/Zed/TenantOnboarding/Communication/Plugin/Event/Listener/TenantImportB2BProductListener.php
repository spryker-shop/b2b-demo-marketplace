 ...
 */
class TenantImportB2BProductListener extends AbstractTenantPartialImportListener implements EventBulkHandlerInterface
{
    protected const DATA_IMPORT_FULL_CONFIG_PATH = 'data/import/tenant/partial/b2b_product.yml';
}
