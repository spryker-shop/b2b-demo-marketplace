 ...
 */
class TenantImportCmsListener extends AbstractTenantPartialImportListener implements EventBulkHandlerInterface
{
    protected const DATA_IMPORT_FULL_CONFIG_PATH = 'data/import/tenant/partial/cms.yml';
}
