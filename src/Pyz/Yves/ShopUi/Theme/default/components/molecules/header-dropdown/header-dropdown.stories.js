...
const docs = componentDocs({
    ...
    data: [
        { prop: 'preset', type: 'string', default: 'required', desc: "Dropdown preset: 'user-account' or 'self-service'" },
        ...
        { prop: 'isDrawer', type: 'boolean', default: 'false', desc: 'Drawer (mobile) mode — changes chevron and layout' },
        { prop: 'drillDownTarget', type: 'string', default: "''", desc: 'Target panel id for drawer drill-down navigation' },
        { prop: 'panelOnly', type: 'boolean', default: 'false', desc: 'Show only panel content without trigger button' },
    ],
});

export default { title: 'Molecules/Header Dropdown' };
...
export const Overview = {
    ...
    render: () => {
        ...
        return (
            sectionFull('User Account preset',
            ...
            sectionFull('User Account — panel only',
                renderMolecule('header-dropdown', {
                    data: {
                        preset: 'user-account',
                        userName: 'John Doe',
            ...
            sectionFull('Self-Service preset',
                renderMolecule('header-dropdown', {
                    data: {
                        preset: 'self-service',
                    },
            ...
            sectionFull('Drawer mode (user-account)',
                renderMolecule('header-dropdown', {
                    data: {
                        preset: 'user-account',
                        userName: 'Jane Smith',
