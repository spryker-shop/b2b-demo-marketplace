...
const docs = componentDocs({
    ...
    data: [
        ...
        { prop: 'isBackground', type: 'boolean', default: 'false', desc: 'Render as background-image div instead of img' },
    ...
    modifiers: [
        'smaller', 'configured-bundle', 'order-success', 'pdp-bundle',
        'category-list', 'catalog', 'category', 'shopping-list', 'cart',
        'summary', 'full-size', 'category-list-item', 'table',
    ],
    notes: 'Pyz overrides vendor lazy-image with additional size modifiers. Twig lives in vendor.',
});

export default { title: 'Molecules/Lazy Image' };
...
export const Overview = {
    render: () => {
        return (
            ...
            sectionFull('Full-size modifier',
                renderMolecule('lazy-image', {
                    modifiers: ['full-size'],
                    data: {
