...
const docs = componentDocs({
    ...
    data: [
        ...
        { prop: 'actions', type: 'array', default: '[]', desc: 'Action objects: { url, title, icon?, primary?, modifiers?, block?, qa? }' },
    ],
...
export default { title: 'Molecules/Action Bar' };

export const Overview = {
    render: () => {
        return (
            sectionFull('With title and actions',
