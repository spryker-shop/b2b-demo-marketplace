export default { title: 'Basic/Typography' };
...
const rowStyle = 'display: grid; grid-template-columns: 160px 1fr 200px; gap: 16px; align-items: baseline; padding: 8px 0; border-bottom: 1px solid #f0f0f0;';
