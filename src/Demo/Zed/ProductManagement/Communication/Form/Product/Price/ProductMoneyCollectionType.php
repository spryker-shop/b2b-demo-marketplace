...
class ProductMoneyCollectionType extends SprykerProductMoneyCollectionType
{
    ...
    public function finishView(FormView $view, FormInterface $form, array $options): void // phpcs:ignore SlevomatCodingStandard.Functions.UnusedParameter.UnusedParameter
    {
        ...
        $view->vars['priceModeGross'] = $this->getGrossPriceModeIdentifier();
        $view->vars['priceModeNet'] = $this->getNetPriceModeIdentifier();
        $view->vars['priceModeCost'] = $this->getCostPriceModeIdentifier();
        $view->vars['priceModeBoth'] = $this->getPriceModeIdentifierForBothType();
    ...
    protected function isVolumePriceNotApplicable(FormView $productMoneyTypeFormView): bool
    {
        ...
        return !$priceProductTransfer->getIdPriceProduct()
            || (!$moneyValueTransfer->getGrossAmount() && !$moneyValueTransfer->getNetAmount() && !$moneyValueTransfer->getCostAmount());
    }
}
