 ...
 */
class CostPriceProductAbstractTableConfigurationExpanderPlugin extends AbstractPlugin implements PriceProductAbstractTableConfigurationExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Adds the "Cost Default" column to the abstract product price table for the DEFAULT price type only.
     *
     * @api
     *
