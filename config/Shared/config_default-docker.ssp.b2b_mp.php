...
$config[FileSystemConstants::FILESYSTEM_SERVICE] = [
    'ssp-inquiry' => [
        ...
        'bucket' => 'shared-01-11-scos-bucket-ssp-claim-storage',
    ...
    'files' => [
        ...
        'bucket' => 'shared-01-11-scos-bucket-ssp-files-storage',
        'region' => getenv('AWS_REGION'),
        'version' => 'latest',
        'root' => '/files',
        'path' => '',
    ...
    'ssp-asset-image' => [
        'sprykerAdapterClass' => Aws3v3FilesystemBuilderPlugin::class,
        'key' => getenv('TEST_BUCKET_6_SSP_ASSETS_STORAGE_S3_KEY_ACTUAL') ?: '',
        'secret' => getenv('TEST_BUCKET_6_SSP_ASSETS_STORAGE_S3_SECRET_ACTUAL') ?: '',
        'bucket' => 'shared-01-11-scos-bucket-ssp-assets-storage',
        'region' => getenv('AWS_REGION'),
        'version' => 'latest',
    ...
    'ssp-model-image' => [
        ...
        'bucket' => 'shared-01-11-scos-bucket-ssp-models-storage',
        'region' => getenv('AWS_REGION'),
        'version' => 'latest',
