...
$config[FileSystemConstants::FILESYSTEM_SERVICE] = [
    ...
    'ssp-inquiry' => [
        ...
        'bucket' => getenv('B2B_MP_PROD_BUCKET_20_SELF_SERVICE_CLAIM_PRIVATE_S3_BUCKET_ACTUAL') ?: '',
        'region' => $awsRegion,
        'version' => 'latest',
        'root' => '/ssp-inquiry',
        'path' => '',
    ...
    'ssp-files' => [
        ...
        'bucket' => getenv('B2B_MP_PROD_BUCKET_20_SELF_SERVICE_FILES_PRIVATE_S3_BUCKET_ACTUAL') ?: '',
        'region' => $awsRegion,
        'version' => 'latest',
        'root' => '/files',
        'path' => '',
    ...
    'ssp-asset-image' => [
        ...
        'bucket' => getenv('B2B_MP_PROD_BUCKET_20_SELF_SERVICE_ASSETS_ECM_FILES_PRIVATE_S3_BUCKET_ACTUAL') ?: '',
        'region' => $awsRegion,
        'version' => 'latest',
    ...
    'ssp-model-image' => [
        ...
        'bucket' => getenv('B2B_MP_PROD_BUCKET_20_SELF_SERVICE_MODEL_FILES_PRIVATE_S3_BUCKET_ACTUAL') ?: '',
        'region' => $awsRegion,
        'version' => 'latest',
