 ...
 *     ...<string, mixed>
 * }
 * @psalm-type SprykerApiPlatformConfig = array{
 *     source_directories?: list<scalar|Param|null>,
 *     cache_dir?: scalar|Param|null, // Cache directory for generated resources // Default: "%kernel.cache_dir%/api-generator"
 *     generated_dir?: scalar|Param|null, // Directory where generated resources are written // Default: "%kernel.project_dir%/src/Generated/Api"
 *     api_types?: list<scalar|Param|null>,
 *     excluded_path_fragments?: list<scalar|Param|null>,
 *     canonical_object_search_directories?: array<string, list<scalar|Param|null>>,
 *     is_method_not_allowed_status_enabled?: bool|Param, // Answer a request whose path exists but declares no operation for its HTTP method with 405 and an Allow header, per RFC 9110. Disable it to answer 404 instead, as the old Glue REST API did. // Default: true
 *     debug?: bool|Param, // Enable debug mode (disables caching, enables verbose output) // Default: "%kernel.debug%"
 * }
 ...
 *     spryker_api_platform?: SprykerApiPlatformConfig,
 *     "when@dockerdev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
 *         framework?: FrameworkConfig,
 ...
 *     "when@dockerdev"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
